...
```javascript
enum2str = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-ztest-alternative-enum2str@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/stats-base-ztest-alternative-enum2str/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-base-ztest-alternative-enum2str/actions/workflows/test.yml?query=branch:v0.1.1
